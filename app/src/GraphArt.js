...
class GraphArt {
  ...
  generate(model,args){
    this.graph = eval(`this.algo.${model}.apply(window,args)`)
    this.params = Object.assign({},this.params,{model,args})
    return this
  }
  render(charge,linkDistance){
    ...
    this.params = Object.assign({},this.params,{charge,linkDistance})
    return this;
  }
  redraw(charge,linkDistance){
    this.force
        .charge(charge*-1)
        .linkDistance(linkDistance)
        .start();
